...
// People-directory card (design system §5.6 / §10). Compact: avatar, name,
// role badge, role title, and up to a few skills (SkillTagList collapses at 6).
      ...
      <div className="flex items-center gap-3 mb-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            <h2 className="text-body font-semibold text-white truncate">{user.name}</h2>
